...
\begin{figure}
\centering \epsfig{file=fly.eps, height=1in, width=1in} \caption{A
...
enclose the figure and its caption.
\begin{figure*}
\centering \epsfig{file=flies.eps} \caption{A sample black and
...
\begin{figure}
\centering \psfig{file=rosette.ps, height=1in, width=1in,}
